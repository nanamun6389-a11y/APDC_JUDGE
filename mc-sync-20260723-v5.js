...
function openingEnglish(){return [
  ...
  "He has worked hard to make this event possible.",
  ...
  "Now, the representatives of each country will join us for the Country Team Match parade.",
  "Please welcome the teams representing Korea, Japan, Taiwan, Hong Kong, Macao, Singapore, and Malaysia.","",
  "[AFTER THE TEAM MATCH PARADE]",
  "Team Match dancers, please move to your starting positions.","",
  "Next, our Judges will enter as we introduce them one by one.","",
...
function openingKorean(){return [
  ...
  "이번 대회를 위해 많은 시간과 열정을 다해 준비해 주셨습니다.",
  "큰 박수로 맞아주시기 바랍니다.","",
  "이어서 APDC의 첫걸음에 큰 힘과 응원을 보내주신 특별한 분을 소개하겠습니다.",
  "한국프로댄스협회 회장이자 코리아오픈 조직위원장이신 박지우 선생님입니다.",
  "APDC를 위해 보내주신 소중한 도움과 응원에 깊이 감사드립니다.","",
  "이제 각 국가를 대표하는 Country Team Match 선수들의 행진이 있겠습니다.",
  "한국, 일본, 대만, 홍콩, 마카오, 싱가포르, 말레이시아를 대표하는 선수 여러분을 맞아주시기 바랍니다.","",
  "[TEAM MATCH 행진 완료 후]",
  "Team Match 선수 여러분은 경기 시작 위치로 이동해 주시기 바랍니다.","",
  "이어서 오늘 APDC 2026의 심사를 맡아주실 심사위원 여러분을 한 분씩 소개하며 모시겠습니다.","",
  "International Judges",
